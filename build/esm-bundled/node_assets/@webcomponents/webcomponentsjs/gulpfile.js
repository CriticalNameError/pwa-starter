...
function closurify(sourceName, fileName) {
  ...
  const closureOptions = {
    ...
    externs: [
      ...
      'node_assets/@webcomponents/custom-elements/externs/custom-elements.js',
      'node_assets/@webcomponents/shadycss/externs/shadycss-externs.js',
      'node_assets/@webcomponents/shadydom/externs/shadydom.js'
    ]
  };
  ...
  return gulp.src([
      'entrypoints/*.js',
      'src/*.js',
      'node_assets/es-symbol/**/*.js',
      'node_assets/es6-promise/lib/es6-promise/**/*.js',
      'node_assets/@webcomponents/**/*.js',
      '!node_assets/@webcomponents/*/externs/*.js',
      '!node_assets/@webcomponents/*/node_assets/**',
      '!**/bower_components/**'
    ], {base: './', follow: true})
