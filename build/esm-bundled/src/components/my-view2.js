import{LitElement,html,plusIcon,minusIcon,ButtonSharedStyles,PageViewElement,SharedStyles,connect,store}from"./my-app.js";const INCREMENT="INCREMENT",DECREMENT="DECREMENT",increment=()=>{return{type:INCREMENT}},decrement=()=>{return{type:DECREMENT}};var counter={INCREMENT:INCREMENT,DECREMENT:DECREMENT,increment:increment,decrement:decrement};class CounterElement extends LitElement{_render(props){return html`
      ${ButtonSharedStyles}
      <style>
